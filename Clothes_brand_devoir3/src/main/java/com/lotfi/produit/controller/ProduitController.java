package com.lotfi.produit.controller;
...
import com.lotfi.produit.service.ProduitService;
...
public class ProduitController {
	...
	public String listeProduits(ModelMap modelMap, @RequestParam(name = "page", defaultValue = "0") int page, @RequestParam(name = "size", defaultValue = "3") int size) {
	...
	public String supprimerProduit(@RequestParam("id") Long id, ModelMap modelMap , @RequestParam (name="page",defaultValue = "0") int page, @RequestParam (name="size", defaultValue = "3") int size) {
